...
S.virtualsky.plugins = [];
    ...
    // Fallback: create a minimal jQuery-like wrapper if jQuery isn't available
    var $ = window.jQuery;
    if (!$ || !$().ajax) {
                    ...
                    xhr.onload = function() {
                        if (config.success) {
                            if (config.dataType === 'json') {
                                config.success.call(config["this"], JSON.parse(xhr.responseText));
                            } else {
                                config.success.call(config["this"], xhr.responseText);
                            }
                        }
                    };
                    xhr.send();
